...
'''
text_train, text_test, y_train, y_test = train_test_split(text_train, y_train, test_size=0.20, random_state=42)
...
#First Hidden Layer
classifier.add(Dense(25, activation='relu', kernel_initializer='random_normal', input_dim=len(feature_names), kernel_regularizer=regularizers.l2(0.0001)))
#Second  Hidden Layer
